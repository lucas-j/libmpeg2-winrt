...
_EXPORT int mpeg2_convert (mpeg2dec_t * mpeg2dec, mpeg2_convert_t convert, void * arg);
_EXPORT int mpeg2_stride (mpeg2dec_t * mpeg2dec, int stride);
_EXPORT void mpeg2_set_buf (mpeg2dec_t * mpeg2dec, uint8_t * buf[3], void * id);
_EXPORT void mpeg2_custom_fbuf (mpeg2dec_t * mpeg2dec, int custom_fbuf);
...
_EXPORT uint32_t mpeg2_accel (uint32_t accel);
_EXPORT mpeg2dec_t * mpeg2_init (void);
_EXPORT const mpeg2_info_t * mpeg2_info (mpeg2dec_t * mpeg2dec);
_EXPORT void mpeg2_close (mpeg2dec_t * mpeg2dec);

_EXPORT void mpeg2_buffer (mpeg2dec_t * mpeg2dec, uint8_t * start, uint8_t * end);
_EXPORT int mpeg2_getpos (mpeg2dec_t * mpeg2dec);
_EXPORT mpeg2_state_t mpeg2_parse (mpeg2dec_t * mpeg2dec);

_EXPORT void mpeg2_reset (mpeg2dec_t * mpeg2dec, int full_reset);
_EXPORT void mpeg2_skip (mpeg2dec_t * mpeg2dec, int skip);
_EXPORT void mpeg2_slice_region (mpeg2dec_t * mpeg2dec, int start, int end);

_EXPORT void mpeg2_tag_picture (mpeg2dec_t * mpeg2dec, uint32_t tag, uint32_t tag2);

_EXPORT void mpeg2_init_fbuf (mpeg2_decoder_t * decoder, uint8_t * current_fbuf[3],
		      uint8_t * forward_fbuf[3], uint8_t * backward_fbuf[3]);
_EXPORT void mpeg2_slice (mpeg2_decoder_t * decoder, int code, const uint8_t * buffer);
_EXPORT int mpeg2_guess_aspect (const mpeg2_sequence_t * sequence,
...
_EXPORT void * mpeg2_malloc (unsigned size, mpeg2_alloc_t reason);
_EXPORT void mpeg2_free (void * buf);
_EXPORT void mpeg2_malloc_hooks (void * malloc (unsigned, mpeg2_alloc_t),
			 int free (void *));
